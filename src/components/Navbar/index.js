...
const Navbar = () => {
  ...
  return (
    <div>
      {/* <nav class={` px-2 sm:px-4 py-2.5 rounded ${isFixed ? "fixed top-0 left-0 right-0  z-40" : ""} ${bgColor}`}> */}
      <nav class={` px-2 sm:px-4 py-2.5 rounded ${isFixed ? "fixed navbar-scroll-down left-0 right-0  z-40" : "navbar-scroll-up"} `}>
